...
This library is used by [prototype.face-similarity repo](https://github.com/popsa-hq/prototype.face-similarity). Note, this is currently in a [PR](https://github.com/popsa-hq/prototype.face-similarity/pull/39).
